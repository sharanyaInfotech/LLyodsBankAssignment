...
class CategoryAdapter(private val listner: OnItemClickListner) :
    ...
    inner class CategoryDataViewHolder(val binding: ItemCategoryListBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bindData(position: Int) {
            with(binding){
                ...
                binding.categoryDataContainer.setOnClickListener{
